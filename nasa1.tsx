...
router.get("/", async (req, res) => {
    var apikey = gi0lo83R8cQXhm6Ul3QKBPjNoEriUTOQT66QZGY6
        var response = await fetch('https://api.nasa.gov/planetary/apod?api_key=gi0lo83R8cQXhm6Ul3QKBPjNoEriUTOQT66QZGY6');
        .then(function (res){
            var info = await return response.json()
        })
        .then(function (data){
            var thedata = await return document.querySelector().innerHTML = info.explanation

            var App = () => <h1>thedata</h1>
