...
import React, {useEffect, useState} from "https://jspm.dev/react@17.0.2";
...
var Posts = function({results: query}){
...
export async function getServerSideProps(context){
  var res = await fetch(`https://jsonplaceholder.typicode.com/posts/?q=${context.params.query}`)
